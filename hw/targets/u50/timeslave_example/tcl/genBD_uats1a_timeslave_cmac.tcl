...
proc create_hier_cell_clock_and_resets { parentCell nameHier } {
  ...
  connect_bd_net -net cmac_usplus_0_gt_txusrclk2 [get_bd_pins usr_tx_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net cmac_usplus_0_usr_tx_reset [get_bd_pins usr_tx_reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  ...
  connect_bd_net -net s_axi_sreset_0_1 [get_bd_pins clk_100_reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins rst_clk_100MHz_100M/ext_reset_in]
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins clock_and_resets/gt_ref_clk] [get_bd_pins cmac_usplus_0/drp_clk] [get_bd_pins cmac_usplus_0/gt_ref_clk_out] [get_bd_pins cmac_usplus_0/init_clk]
  connect_bd_net -net cmac_usplus_0_gt_rxusrclk2 [get_bd_pins cmac_usplus_0/gt_rxusrclk2] [get_bd_pins timeslave_0/now_clk_0]
  connect_bd_net -net cmac_usplus_0_gt_txusrclk2 [get_bd_pins clock_and_resets/usr_tx_clk] [get_bd_pins cmac_usplus_0/gt_txusrclk2] [get_bd_pins cmac_usplus_0/rx_clk] [get_bd_pins loopback_fifo/s_axis_aclk] [get_bd_pins timeslave_0/now_clk_1] [get_bd_pins timeslave_0/now_clk_2] [get_bd_pins timeslave_0/now_clk_3] [get_bd_pins timeslave_0/s_axis_aclk]
  ...
  connect_bd_net -net cmac_usplus_0_usr_tx_reset [get_bd_pins clock_and_resets/usr_tx_reset] [get_bd_pins cmac_usplus_0/usr_tx_reset]
  ...
  connect_bd_net -net proc_sys_reset_2_peripheral_reset [get_bd_pins clock_and_resets/peripheral_reset] [get_bd_pins cmac_usplus_0/core_drp_reset] [get_bd_pins cmac_usplus_0/sys_reset]
  ...
  connect_bd_net -net s_axi_aclk_0_1 [get_bd_ports clk_100MHz] [get_bd_pins clock_and_resets/clk_100MHz] [get_bd_pins cmac_usplus_0/s_axi_aclk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins jtag_axi_0_axi_periph/ACLK] [get_bd_pins jtag_axi_0_axi_periph/M00_ACLK] [get_bd_pins jtag_axi_0_axi_periph/M01_ACLK] [get_bd_pins jtag_axi_0_axi_periph/S00_ACLK] [get_bd_pins timeslave_0/s_axi_aclk]
  connect_bd_net -net s_axi_sreset_0_1 [get_bd_ports clk_100_reset] [get_bd_pins clock_and_resets/clk_100_reset] [get_bd_pins cmac_usplus_0/s_axi_sreset]
